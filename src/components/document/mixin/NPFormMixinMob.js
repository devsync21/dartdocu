...
export default {
  methods: {
    ...
    uploadDiv() {
      ...
      this.message2 = "We are sending 1st Page to D'Art Dental";
    ...
    uploadDiv2(doc, width, height) {
      this.message = "Please Wait....   ";
      this.message2 = "We are sending 2nd Page to D'Art Dental";
    ...
    uploadDiv3(doc, width, height) {
      this.message = "Please Wait....   ";
      this.message2 = "We are sending 3rd Page to D'Art Dental";
